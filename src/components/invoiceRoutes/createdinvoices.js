...
return <>
 {isLoading ? (<div className="text-center"><img src={loader} alt='fetching data'/></div>) : (<div className="container" id="List__Container">
             <div className="row">
                         ...
                         return <div className="col-md-3 mt-2">
                             <div class="card  mb-3 d-flex align-items-stretch h-100" id="List__cards">
                                 <div class="card-body text-dark">
                                     ...
                                     <h6 className="card-text"><b>Student's Email Id : {obj.studentEmail}</b></h6>                                     <h6 className="card-text"><b>Class Title : {obj.classTitle}</b></h6>                                     <h6 className="card-text"><b>Class Start Time : {obj.startTime}hrs</b></h6>
